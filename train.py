...
def main(args):
    ...
    print(f'{args.train_split} set: {len(train_loader.dataset)}, '
          ...
          f'{args.test_split} set: {len(test_loader.dataset)}, '
    ...
    best_metric, epoch, best_model = trainer(epoch=args.train_epoch,
                                 model=model,
    ...
    test_gt, test_probs = test_trainer(
        model=best_model,
...
def trainer(epoch, model, train_loader, valid_loader, criterion, optimizer, lr_scheduler,
    ...
    for i in range(epoch):
        ...
        print(f'Evaluation on valid set, \n',
              'ma: {:.4f},  pos_recall: {:.4f} , neg_recall: {:.4f} \n'.format(
    ...
    return maximum, best_epoch, best_model
